...
select object_schema_name(object_id) + '.' + object_name(object_id) as TableName, partition_number as 'Partition', cte.column_id as 'Column Id', cte.ColumnName, 
	cte.ColumnType,
	...
	group by object_schema_name(object_id) + '.' + object_name(object_id), partition_number, cte.column_id, cte.ColumnName, cte.ColumnType
	order by object_schema_name(object_id) + '.' + object_name(object_id), partition_number, cte.column_id;
